...
int initialization_real (int argc, char** argv)
{
    ...
    else
    {
        ...
        // configure with argv
        while ( (c = getopt(argc, argv, "a:c:x:y:s:g:i:b:e:w:p:ho:f:m:n:d:k:j:")) != -1) {
            switch (c){
                case 'c':
                    flag_default = 0;
                ...
                case 'e':
                    ...
                    break;
                case 'f':
                    reference_point[0] = atof(optarg);
                    break;
                case 'm':
                    reference_point[1] = atof(optarg);
                    break;
                case 'n':
                    reference_point[2] = atof(optarg);
                    break;
                case 'd':
                    reference_point[3] = atof(optarg);
                    break;
                case 'k':
                    reference_point[4] = atof(optarg);
                    break;
                case 'j':
                    directory_index = atof(optarg);
                    break;
                case 'w':
